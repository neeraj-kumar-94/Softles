...
export default function ShopifyTechStack() {
  const techs = [
    ...
    { icon: "⭐", name: "Shopify Plus", desc: "Enterprise Commerce" },
    { icon: "💧", name: "Liquid", desc: "Template Language" },
    { icon: "⚗️", name: "Hydrogen", desc: "Headless Framework" },
    { icon: "⚛️", name: "React", desc: "Storefront UI" },
    { icon: "▲", name: "Next.js", desc: "Commerce Framework" },
    { icon: "◈", name: "GraphQL", desc: "Storefront API" },
    { icon: "📧", name: "Klaviyo", desc: "Email Automation" },
  ];
